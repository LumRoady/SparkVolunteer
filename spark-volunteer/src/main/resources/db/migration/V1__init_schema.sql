...
-- 9. 任务挑战表
CREATE TABLE IF NOT EXISTS `task_challenge` (
  `id`               BIGINT        NOT NULL AUTO_INCREMENT  COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `task_assignment` (
  ...
  KEY `idx_task_assignment_volunteer_id` (`volunteer_id`),
  KEY `idx_task_assignment_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='任务分配关系表';
